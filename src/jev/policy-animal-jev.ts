...
const FACTS = "Facts measured on the reference trader over 2,212 markets in eight days (14-22 Sep 2026): his hedge filled in 76% of markets; 515 tails were never hedged and lost 4,314 USD; a handful of reversals paid about 3,200 USD; hedged markets netted +1.74 each; the eight days netted about -670 USD before maker rebates (+424). The game is a lottery ticket at 0.01 whose cost is paid back only when the hedge fills; the hedge bid is filled by other traders buying the tail after us and by holders selling the leader, and the 0.99 level fills with thousands of shares within seconds of opening, so an early bid fills and a late one does not.";
